...
let desc =
  "Generate short, memorable links with ease using Linkzip’s intuitive interface. Share URLs effortlessly across platforms. Optimize your sharing strategy with Linkzip. Track clicks and manage your links seamlessly to enhance your online presence. Generate short, memorable links with ease using Linkzip’s intuitive interface. Share URLs effortlessly across platforms.";
  ...
  return (
    <div className="min-h-[calc(100vh-64px)]  lg:px-14 sm:px-8 px-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <motion.button
              ...
              className="border-btnColor border w-40 text-btnColor rounded-md py-2 
               transition-all duration-300 hover:bg-btnColor hover:text-white hover:scale-105"
            >
              Create Short Link
            </motion.button>
          </div>
      ...
      <div className="sm:pt-12 pt-7">
        ...
        >
          Built with precision to make link sharing effortless{" "}
        </motion.p>
